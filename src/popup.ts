document.addEventListener("DOMContentLoaded", () => {
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    ...
    if (activeTab.url.startsWith("https://leetcode.com/problems/")) {
      ...
      const t = document.querySelector(".tabs") as HTMLElement;
      ...
      const hintsLoader = document.getElementById(
        "spinner"
      ) as HTMLButtonElement;
      const userAuthandHints = document.getElementById(
        "user-auth-hints"
      ) as HTMLElement;
      const userAuth = document.getElementById("user-auth") as HTMLElement;
      const string =
          ...
          try {
            ...
            if (res.status === 201) {
              ...
              logoutButton.addEventListener("click", function () {
                ...
                const hintContainer = document.getElementById(
                  "hintContainer"
                ) as HTMLElement;
                      ...
                      deleteButton.addEventListener("click", async () => {
                        try {
                          ...
                          if (res.status === 201) {
                            ...
                            const resultElementt = document.getElementById(
                              "submission-status"
                            ) as HTMLElement;
      ...
      const resultElement = document.getElementById("hint") as HTMLElement;
